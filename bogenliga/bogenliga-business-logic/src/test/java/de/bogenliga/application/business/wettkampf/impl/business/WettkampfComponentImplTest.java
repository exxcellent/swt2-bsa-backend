...
public class WettkampfComponentImplTest {
    ...
    private static final long wettkampf_kampfrichter_Id = 6;
    ...
    public void findById() {
        ...
        assertThat(actual.getKampfrichterID())
                .isEqualTo(expectedDO.getKampfrichterID());
    ...
    public void create() {
        ...
        assertThat(actual.getKampfrichterID())
                .isEqualTo(input.getKampfrichterID());
        assertThat(actual.getWettkampfAusrichter())
